                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="shift" class="form-control validate text-white p-input" id="shift" >
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="provident_fund_contributor" class="form-control validate text-white p-input" id="provident_fund_contributor" >
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="min_com_cert" class="col-form-label ">MinCom Certification</label>
                      <select name="min_com_cert" class="form-control validate text-white p-input" id="min_com_cert" >
                        <option value="">--None--</option>
